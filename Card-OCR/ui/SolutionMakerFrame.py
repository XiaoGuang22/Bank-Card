...
class SolutionMakerFrame(tk.Frame):
    ...
    def _create_field_selection(self):
        ...
        chk_anchor = tk.Checkbutton(
            row2,
            text="☑ 标记为锚点 (FirstDigitAnchor)",
            variable=self.var_is_anchor,
            font=("微软雅黑", 9),
            bg="#f0f0f0",
            fg="#8e44ad",
            selectcolor="#f0f0f0",
            activebackground="#f0f0f0",
            command=self._on_anchor_toggled
        )
        chk_anchor.pack(side=tk.LEFT)
    ...
    def _create_tool_buttons(self):
        ...
        btn_open.pack(side=tk.LEFT, padx=(0, 5), fill=tk.X, expand=True)
        ...
        btn_capture.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ...
        btn_extract.pack(side=tk.LEFT, padx=(0, 5), fill=tk.X, expand=True)
    ...
    def _register_field(self, field_type, create_ui=True):
        ...
        if field_type not in self.field_types:
            ...
            # 更新下拉框
            self.combo_field['values'] = self.field_types
