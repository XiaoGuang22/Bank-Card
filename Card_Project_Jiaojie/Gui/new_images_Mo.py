...
#
# # 字体路径（数字字体建议使用等宽或类似“Seven Segment”风格字体）
# # 你可以用系统自带的等宽字体，也可以下载类似“DS-Digital”这种数字感强的字体
# font_path = "D:\\PayCard_Detection\\Data\\ziti\\Farrington-7B\\Farrington-7B.ttf"  # 根据实际情况修改
